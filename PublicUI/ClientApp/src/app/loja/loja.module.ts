...
import { LojaEsqueciSenhaComponent } from './esqueci-senha/loja-esqueci-senha.component';
import { LojaResetSenhaComponent } from './reset-senha/loja-reset-senha.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'esqueci-senha', component: LojaEsqueciSenhaComponent },
      { path: 'reset-senha', component: LojaResetSenhaComponent }
    ]
  }
];
...
@NgModule({
  declarations: [
    ...
    LojaNavComponent,
    LojaPerfilComponent,
    LojaEsqueciSenhaComponent,
    LojaResetSenhaComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
